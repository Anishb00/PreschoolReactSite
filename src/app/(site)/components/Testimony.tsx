export default function Testimony() {
  return (
    <section className="flex w-full items-center justify-start bg-gray-200 px-8 py-16">
      <div className="w-full max-w-5xl rounded-xl bg-[#FFCC00] p-10 text-black shadow-lg">
