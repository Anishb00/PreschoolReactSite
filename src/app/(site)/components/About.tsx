export default function About() {
  return (
    <section className="flex w-full flex-col items-center space-y-24 pt-16">
      {/* Welcome Section */}
      ...
      <div className="flex max-w-[1233px] flex-col items-center justify-center gap-[11px] lg:flex-row">
        <h2 className="text-center text-5xl font-semibold lg:w-1/3">
          The Stepping
          <br />
          Stone Family
        </h2>

        <div className="h-[387px] w-[387px] bg-gray-300" />

        <p className="paragraph self-end lg:w-1/3">
          We believe families are key to a child’s growth. That’s why we share
          regular updates, joyful photos, and little milestones— so you’re part
          of every step. Together, we build a bond of trust, joy, and
          celebration.
        </p>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-between gap-8 lg:flex-row">
        <div className="h-[450px] w-1/2 bg-gray-300" />
